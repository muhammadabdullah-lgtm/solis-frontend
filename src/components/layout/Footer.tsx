  ...
  return (
    ...
    >
      <g clipPath="url(#fb-clip)">
        ...
        />
        <path
          d="M12.99 18.667V12.333H14.765L15 10.15H12.99L12.993 9.057C12.993 8.488 13.048 8.183 13.878 8.183H14.988V6H13.212C11.08 6 10.33 7.059 10.33 8.84V10.15H9V12.333H10.33V18.667H12.99Z"
          fill="#404553"
        />
      </g>
      <defs>
  ...
  return (
    ...
    >
      <g clipPath="url(#li-clip)">
        ...
        />
        <path
          d="M7.7771 7.87239C8.5371 7.87239 9.0001 7.31939 9.0001 6.63639C8.9851 5.93639 8.5381 5.40039 7.8071 5.40039C7.0771 5.40039 6.6001 5.93739 6.6001 6.63639C6.6001 7.31939 7.0621 7.87239 7.7771 7.87239ZM6.6601 8.84839V16.8004H8.9261V8.84839H6.6601Z"
          fill="#404553"
        />
        <path
          d="M10.2662 11.605C10.2662 10.654 10.2332 9.858 10.2002 9.172H12.4002L12.5172 10.232H12.5672C12.9002 9.734 13.7172 9 15.0832 9C16.7502 9 18.0002 10.045 18.0002 12.291V16.8H15.4662V12.572C15.4662 11.59 15.1002 10.919 14.1832 10.919C13.4832 10.919 13.0672 11.371 12.8832 11.809C12.8172 11.964 12.8002 12.182 12.8002 12.401V16.8H10.2662V11.605Z"
          fill="#404553"
        />
      </g>
      <defs>
...
function MastercardIcon() {
  return (
    ...
    >
      ...
      <defs>
        <clipPath id="mc-clip">
          <rect width="41" height="26.4516" fill="white" />
        </clipPath>
      </defs>
    </svg>
  );
  ...
  return (
    ...
    >
      <g clipPath="url(#amex-clip)">
        <path
          d="M37.6923 3.46667V4.816V21.5947V22.5333C37.6923 23.3547 37.0411 24 36.2123 24H4.48005C3.65122 24 3 23.3547 3 22.5333V3.46667C3 2.64533 3.65122 2 4.48005 2H36.2123C37.0411 2 37.6923 2.64533 37.6923 3.46667Z"
          fill="white"
        />
        <path
          d="M34.7914 21.5947L33.2522 19.8933L31.6537 21.5947H28.516H21.767V13.6747H18.6293L22.5366 4.816H26.3255L27.6872 7.86667V4.816H32.4233L33.2522 7.104L34.081 4.816H37.6923V3.46667C37.6923 2.64533 37.0411 2 36.2123 2H4.48005C3.65122 2 3 2.64533 3 3.46667V22.5333C3 23.3547 3.65122 24 4.48005 24H36.2123C37.0411 24 37.6923 23.3547 37.6923 22.5333V21.5947H34.7914Z"
          fill="#0071CE"
        />
        <path
          d="M35.2056 20.657H37.6921L34.436 17.1957L37.6921 13.793H35.2648L33.1927 16.0223L31.1799 13.793H28.6934L32.0087 17.2543L28.6934 20.657H31.1207L33.1927 18.4277L35.2056 20.657Z"
          fill="#0071CE"
        />
        <path
          d="M24.727 19.073V18.017H28.6343V16.433H24.727V15.377H28.6935V13.793H22.8325V20.657H28.6935V19.073H24.727Z"
          fill="#0071CE"
        />
        <path
          d="M35.8568 12.7937H37.6329V5.87109L34.7912 5.92976L33.252 10.2124L31.6535 5.92976H28.6934V12.7937H30.5879V7.98309L32.3639 12.7937H34.0216L35.8568 7.98309V12.7937Z"
          fill="#0071CE"
        />
        <path
          d="M25.6743 5.93164H23.247L20.1685 12.7956H22.2405L22.8326 11.4463H26.0295L26.6215 12.7956H28.7528L25.6743 5.93164ZM23.4838 9.86231L24.431 7.63297L25.3782 9.86231H23.4838Z"
          fill="#0071CE"
        />
        <path
          d="M35.9756 17.0179L37.6924 18.8953V15.1406L35.9756 17.0179Z"
          fill="#0071CE"
        />
      </g>
      <defs>
  ...
  return (
    <footer className="font-sans  ">
      ...
      <div className="bg-noon-bg border-t border-noon-border">
        <div className="px-4 md:px-[24px] py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
          {/* Left: title + subtitle */}
          <div>
      ...
      <div className="  border-t border-noon-border">
        <div className="bg-white px-4 md:px-[24px] pt-6 pb-0">
          {/* 9-column links grid */}
          ...
          <div className="w-full flex flex-col lg:flex-row items-start justify-between gap-4 py-8 mt-4">
            {/* Shop On The Go */}
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex items-center gap-1">
                <a
                  href="#"
                  className="flex items-center justify-center w-[41px] h-[41px]"
                >
                  <FacebookIcon />
                </a>
                <a
        ...
        <div className="bg-noon-bg border-t  border-noon-border bg-noon-bg h-[115px] ">
          <div className="px-4 md:px-[24px] py-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            {/* Copyright */}
